...
const Profile = () => {
  ...
  const socialMediaPlatforms = [
    ...
    { name: 'Google Scholar', icon: FaUserGraduate, prefix: 'scholar.google.com/', placeholder: 'username'},
  ];
      ...
      <div className=" dark:bg-bg-primary-dark relative min-h-screen">
                ...
                <div className="px-6 sm:px-8 pb-6 sm:pb-8">
                  <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 -mt-16 sm:-mt-20 mb-6">
                    ...
                    <div className="flex gap-4 ml-auto items-center">
                      <button className="rounded-full border-border flex items-center mt-25 cursor-pointer">
                    ...
                    <div className="flex items-center gap-3 mt-4 text-gray-700 dark:text-gray-300">
                      {profileData.linkedin && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-muted-foreground transition-colors hover:text-text-light dark:hover:text-text-dark"
                        >
        ...
        `}
                ...
                <div className="mt-6 mb-5 dark:bg-bg-secondary-dark rounded-2xl dark:border-bg-secondary-dark">
                  ...
                  {activeTab === "reading" && (
                    <div className="p-6 bg-card rounded-2xl border border-gray-200 shadow-xl dark:border-bg-secondary-dark">
                      <h3 className="mb-2 font-semibold text-2xl">
                        Your Reading Lists Appear Here
                      </h3>
                                  ...
                                  <div className="flex items-start gap-4 flex-1 min-w-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-center gap-3 mb-2">
                                        <h3
                                          className="text-xl font-bold text-gray-900 group-hover:text-text-light transition-colors
                                    dark:text-gray-100 dark:group-hover:text-text-dark"
                                        >
                                          {collection.title}
                                        </h3>
                                        <span
                                          className={`px-3 py-1.5 text-xs font-semibold rounded-full text-white bg-primary`}
                                        >
                  ...
                  {activeTab === "archived" && (
                    <div className="p-6 bg-card rounded-2xl border border-gray-200 shadow-xl dark:border-bg-secondary-dark">
                      <h3 className="mb-2 font-semibold text-2xl">
                        Your Archieved Posts Appear Here
                      </h3>
                      <div className="flex flex-col items-center dark:bg-bg-secondary-dark rounded-xl dark:border-bg-secondary-dark">
                        {posts.map((post) => (
                          <Post
                ...
                dark:border-2     dark:bg-bg-secondary-dark dark:border-bg-secondary-dark dark:hover:border-blue-900/10 dark:shadow-2xl"
                          >
                            <p className="text-sm text-muted-foreground text-text-light dark:text-text-dark">
                              {item.label}
                            </p>
                ...
                dark:border-2     dark:bg-bg-secondary-dark dark:border-bg-secondary-dark dark:hover:border-blue-900/10 dark:shadow-2xl"
                      >
                        <h3 className="mb-4 font-semibold dark:text-gray-200">
                          Profile Views
                        </h3>
          ...
          <div className="fixed inset-0 z-999 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-bg-secondary-dark w-full max-w-175 max-h-[90vh] rounded-3xl shadow-2xl border-2 border-[#62b6cb]/20 flex flex-col">
              ...
              <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1 dark:text-gray-300">
                    Update your profile information, images, and social media
                    links.
                  </p>
                </div>
                <button
              ...
              <div className="p-6 space-y-6 overflow-y-scroll no-scrollbar">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border-2 border-[#62b6cb]/20 h-32 group">
                    ...
                    <button
                      onClick={() =>
                        document.getElementById("cover-upload-modal")?.click()
                      }
              ...
              >
                <Camera className="w-6 h-6" />
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        onClick={() =>
                          document
                            .getElementById("profile-upload-modal")
                            ?.click()
                        }
                ...
                {/* Social Media */}
                <div className="space-y-4">
                  <label className="text-sm font-bold text-[#1b4965] dark:text-gray-200">
                    Social Media
                  </label>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {socialMediaPlatforms.map((platform, index) => (
                      <div
                        key={platform.name}
                        className={`space-y-2 ${index === 2 ? "sm:col-span-full" : ""}`}
                      >
                        ...
                        <div className="relative">
                          <span className="absolute left-2 top-1/2 -translate-y-1/2 text-xs font-semibold text-gray-400">
                            {platform.prefix}
                          </span>
                          <input
                            type="text"
                            ...
                            className="w-full pl-30 pr-4 py-2 text-sm rounded-xl border border-gray-200 focus:border-[#62b6cb] outline-none dark:bg-gray-800 dark:border-gray-700"
