...
import SearchModal from "../SearchModel/SearchModel.jsx";
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              {/* Search input (desktop) — opens modal on click */}
              <div className="hidden lg:block">
                <button
                  onClick={() => setSearchOpen(true)}
                  className="relative w-64 flex items-center gap-2 rounded-full py-1.5 border-2 border-gray-200 bg-gray-100 pl-9 pr-4 dark:bg-gray-800 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-500 transition-colors cursor-pointer group"
                >
                  <Search
                    size={18}
                    strokeWidth={2.5}
                  ...
                  <span className="ml-auto flex items-center gap-1">
                    <kbd className="hidden xl:inline px-1 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-[10px] font-mono text-gray-400">
                      Ctrl K
                    </kbd>
                  </span>
                </button>
              ...
              {/* Mobile Search Icon */}
              <button
                className="lg:hidden text-gray-700 dark:text-white hover:text-text-light dark:hover:text-text-dark transition-colors"
                onClick={() => setSearchOpen(true)}
              >
